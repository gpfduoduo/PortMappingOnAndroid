 ...
 * Revision;
 *
 * 05/12/03 - first revision. 05/13/03 - Added support for IPv6 and loopback
 * address. 02/15/04 - Added the following methods to set only a interface. -
 * setInterface(), getInterfaces(), hasAssignedInterface() 06/30/04 - Moved the
 * package from org.cybergarage.http to org.cybergarage.net. 06/30/04 - Theo
 * Beisch <theo.beisch@gmx.de> - Changed isUseAddress() to isUsableAddress().
 *
 ******************************************************************/
