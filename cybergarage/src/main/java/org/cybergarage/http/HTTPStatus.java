 ...
 * Revision;
 *
 * 12/17/02 - first revision. 09/03/03 - Added CONTINUE_STATUS. 10/20/04 - Brent
 * Hills <bhills@openshores.com> - Added PARTIAL_CONTENT and INVALID_RANGE;
 * 10/22/04 - Added isSuccessful(). 10/29/04 - Fixed set() to set the version
 * and the response code when the mothod is null. - Fixed set() to read multi
 * words of the response sring such as Not Found.
 *
 ******************************************************************/
