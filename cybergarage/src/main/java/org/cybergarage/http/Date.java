 ...
 * Revision;
 *
 * 01/05/03 - first revision 10/20/04 - Theo Beisch <theo.beisch@gmx.de> - Fixed
 * the following methods to use HOUR_OF_DAY instead of HOUR. getHour(),
 * getDateString() getTimeString() - Fixed getInstance() to return GMT instance.
 *
 ******************************************************************/
...
public class Date
{
    private final static String MONTH_STRING[] = {"Jan", "Feb", "Mar", "Apr", "May",
        "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec",};
    private final static String WEEK_STRING[] = {"Sun", "Mon", "Tue", "Wed", "Thu",
        "Fri", "Sat",};
