 ...
 * Revision;
 *
 * 11/18/02 - first revision. 05/13/03 - Added getLocalAddress(). 11/01/04 -
 * Theo Beisch <theo.beisch@gmx.de> - Fixed isRootDevice() to check the ST
 * header. 11/19/04 - Theo Beisch <theo.beisch@gmx.de> - Changed
