 ...
 * Revision;
 *
 * 12/11/02 - first revision. 05/22/03 - Giordano Sassaroli
 * <sassarol@cefriel.it> - Description: removed the xml namespace - Problem :
 * Notification messages refer to uncorrect variable names - Error : The
 * NotifyRequest class introduces the XML namespace in variable names, too
 * 05/22/03 - Giordano Sassaroli <sassarol@cefriel.it> - Problem : Notification
 * messages refer to uncorrect variable names - Error : The NotifyRequest class
 * introduces the XML namespace in variable names, too - Description : removed
 * the xml namespace 09/03/03 - Giordano Sassaroli <sassarol@cefriel.it> -
 * Problem : Notification messages refer to uncorrect variable names - Error :
 * The NotifyRequest class introduces the XML namespace in variable names, too -
 * Description: removed the xml namespace 09/08/03 - Giordano Sassaroli
 * <sassarol@cefriel.it> - Problem : when an event notification message is
 * received and the message contains updates on more than one variable, only the
 * first variable update is notified. - Error : the other xml nodes of the
 * message are ignored - Fix : add two methods to the NotifyRequest for
 * extracting the property array and modify the httpRequestReceived method in
 * ControlPoint
 *
 ******************************************************************/
