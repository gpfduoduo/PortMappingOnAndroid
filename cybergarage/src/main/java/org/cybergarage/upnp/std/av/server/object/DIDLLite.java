 ...
 * Revision:
 *
 * 10/22/03 - first revision. 10/26/04 - Brent Hills <bhills@openshores.com> -
 * Removed a SOAP header from output(). 10/28/04 - Brent Hills
 * <bhills@openshores.com> - Removed a SOAP header from output(). 04/18/05 -
 * Matt <matthias@streams.ch> - Changed toString() using UTF-8
 * OutputStreamWriter.
 *
 ******************************************************************/
