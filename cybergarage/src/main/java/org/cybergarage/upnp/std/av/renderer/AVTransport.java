...
public class AVTransport implements ActionListener, QueryListener
{
    ...
    public boolean actionControlReceived(Action action)
    {
         ...
         * action.getArgument(RCS_ID).setValue(-1); return true; }
         * 
         * if (actionName.equals(CONNECTION_COMPLETE) == true) { return true; }
         * 
         * if (actionName.equals(GET_CURRENT_CONNECTION_INFO) == true) return
         * getCurrentConnectionInfo(action);
         * 
         * 
         * if (actionName.equals(GET_CURRENT_CONNECTION_IDS) == true) return
