 ...
 * Revision:
 *
 * 10/22/03 - first revision. 01/28/04 - Added file and timestamp parameters.
 *
 ******************************************************************/
...
public class ItemNode extends ContentNode
{
    ...
    {
        if (isUPnPClassStartWith("object.item.movie")
            || isUPnPClassStartWith("object.item.video"))
            return true;
        return false;
    }
    ...
    {
        if (isUPnPClassStartWith("object.item.audio")
            || isUPnPClassStartWith("object.item.music"))
            return true;
        return false;
    }
    ...
    {
        if (isUPnPClassStartWith("object.item.image")
            || isUPnPClassStartWith("object.item.photo"))
            return true;
        return false;
    }
