...
public class RenderingControl implements ActionListener, QueryListener
{
    ...
    public final static String SCPD = "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"
        ...
        + "      </allowedValueList>" + "    </stateVariable>" + "  </serviceStateTable>"
        ...
        + "        </argument>" + "      </argumentList>" + "    </action>"
        + "    <action><Optional/>" + "    <name>GetBrightness</name>"
        + "      <argumentList>" + "        <argument>"
        + "          <name>InstanceID</name>" + "          <direction>in</direction>"
        + "          <relatedStateVariable>A_ARG_TYPE_InstanceID</relatedStateVariable>"
        + "        </argument>" + "        <argument>"
        ...
        + "        </argument>" + "      </argumentList>" + "    </action>"
        + "    <action><Optional/>" + "    <name>SetBrightness</name>"
        + "      <argumentList>" + "        <argument>"
        + "          <name>InstanceID</name>" + "          <direction>in</direction>"
        + "          <relatedStateVariable>A_ARG_TYPE_InstanceID</relatedStateVariable>"
        + "        </argument>" + "        <argument>"
        ...
        + "          <relatedStateVariable>Brightness</relatedStateVariable>"
        + "        </argument>" + "      </argumentList>" + "    </action>"
        + "    <action><Optional/>" + "    <name>GetContrast</name>"
        + "      <argumentList>" + "        <argument>"
        + "          <name>InstanceID</name>" + "          <direction>in</direction>"
        + "          <relatedStateVariable>A_ARG_TYPE_InstanceID</relatedStateVariable>"
        + "        </argument>" + "        <argument>"
        ...
        + "        </argument>" + "      </argumentList>" + "    </action>"
        + "    <action><Optional/>" + "    <name>SetContrast</name>"
        + "      <argumentList>" + "        <argument>"
        + "          <name>InstanceID</name>" + "          <direction>in</direction>"
        + "          <relatedStateVariable>A_ARG_TYPE_InstanceID</relatedStateVariable>"
        + "        </argument>" + "        <argument>"
        ...
        + "          <relatedStateVariable>Contrast</relatedStateVariable>"
        + "        </argument>" + "      </argumentList>" + "    </action>"
        + "    <action><Optional/>" + "    <name>GetSharpness</name>"
        + "      <argumentList>" + "        <argument>"
        + "          <name>InstanceID</name>" + "          <direction>in</direction>"
        + "          <relatedStateVariable>A_ARG_TYPE_InstanceID</relatedStateVariable>"
        + "        </argument>" + "        <argument>"
        ...
        + "        </argument>" + "      </argumentList>" + "    </action>"
        + "    <action><Optional/>" + "    <name>SetSharpness</name>"
        + "      <argumentList>" + "        <argument>"
        + "          <name>InstanceID</name>" + "          <direction>in</direction>"
        + "          <relatedStateVariable>A_ARG_TYPE_InstanceID</relatedStateVariable>"
        + "        </argument>" + "        <argument>"
        ...
        + "          <relatedStateVariable>Sharpness</relatedStateVariable>"
        + "        </argument>" + "      </argumentList>" + "    </action>"
        + "    <action><Optional/>" + "    <name>GetRedVideoGain</name>"
        + "      <argumentList>" + "        <argument>"
        + "          <name>InstanceID</name>" + "          <direction>in</direction>"
        + "          <relatedStateVariable>A_ARG_TYPE_InstanceID</relatedStateVariable>"
        + "        </argument>" + "        <argument>"
        ...
        + "        </argument>" + "      </argumentList>" + "    </action>"
        + "    <action><Optional/>" + "    <name>SetRedVideoGain</name>"
        + "      <argumentList>" + "        <argument>"
        + "          <name>InstanceID</name>" + "          <direction>in</direction>"
        + "          <relatedStateVariable>A_ARG_TYPE_InstanceID</relatedStateVariable>"
        + "        </argument>" + "        <argument>"
        ...
        + "          <relatedStateVariable>RedVideoGain</relatedStateVariable>"
        + "        </argument>" + "      </argumentList>" + "    </action>"
        + "    <action><Optional/>" + "    <name>GetGreenVideoGain</name>"
        + "      <argumentList>" + "        <argument>"
        + "          <name>InstanceID</name>" + "          <direction>in</direction>"
        + "          <relatedStateVariable>A_ARG_TYPE_InstanceID</relatedStateVariable>"
        + "        </argument>" + "        <argument>"
        ...
        + "        </argument>" + "      </argumentList>" + "    </action>"
        + "    <action><Optional/>" + "    <name>SetGreenVideoGain</name>"
        + "      <argumentList>" + "        <argument>"
        + "          <name>InstanceID</name>" + "          <direction>in</direction>"
        + "          <relatedStateVariable>A_ARG_TYPE_InstanceID</relatedStateVariable>"
        + "        </argument>" + "        <argument>"
        ...
        + "          <relatedStateVariable>GreenVideoGain</relatedStateVariable>"
        + "        </argument>" + "      </argumentList>" + "    </action>"
        + "    <action><Optional/>" + "    <name>GetBlueVideoGain</name>"
        + "      <argumentList>" + "        <argument>"
        + "          <name>InstanceID</name>" + "          <direction>in</direction>"
        + "          <relatedStateVariable>A_ARG_TYPE_InstanceID</relatedStateVariable>"
        + "        </argument>" + "        <argument>"
        ...
        + "        </argument>" + "      </argumentList>" + "    </action>"
        + "    <action><Optional/>" + "    <name>SetBlueVideoGain</name>"
        + "      <argumentList>" + "        <argument>"
        + "          <name>InstanceID</name>" + "          <direction>in</direction>"
        + "          <relatedStateVariable>A_ARG_TYPE_InstanceID</relatedStateVariable>"
        + "        </argument>" + "        <argument>"
        ...
        + "          <relatedStateVariable>BlueVideoGain</relatedStateVariable>"
        + "        </argument>" + "      </argumentList>" + "    </action>"
        + "   <action><Optional/>" + "    <name>GetRedVideoBlackLevel</name>"
        + "      <argumentList>" + "        <argument>"
        + "          <name>InstanceID</name>" + "          <direction>in</direction>"
        + "          <relatedStateVariable>A_ARG_TYPE_InstanceID</relatedStateVariable>"
        + "        </argument>" + "        <argument>"
        ...
        + "        </argument>" + "      </argumentList>" + "    </action>"
        + "    <action><Optional/>" + "    <name>SetRedVideoBlackLevel</name>"
        + "      <argumentList>" + "        <argument>"
        + "          <name>InstanceID</name>" + "          <direction>in</direction>"
        + "          <relatedStateVariable>A_ARG_TYPE_InstanceID</relatedStateVariable>"
        + "        </argument>" + "        <argument>"
        ...
        + "          <relatedStateVariable>RedVideoBlackLevel</relatedStateVariable>"
        + "        </argument>" + "      </argumentList>" + "    </action>"
        + "    <action><Optional/>" + "    <name>GetGreenVideoBlackLevel</name>"
        + "      <argumentList>" + "        <argument>"
        + "          <name>InstanceID</name>" + "          <direction>in</direction>"
        + "          <relatedStateVariable>A_ARG_TYPE_InstanceID</relatedStateVariable>"
        + "        </argument>" + "        <argument>"
        ...
        + "        </argument>" + "      </argumentList>" + "    </action>"
        + "    <action><Optional/>" + "    <name>SetGreenVideoBlackLevel</name>"
        + "      <argumentList>" + "        <argument>"
        + "          <name>InstanceID</name>" + "          <direction>in</direction>"
        + "          <relatedStateVariable>A_ARG_TYPE_InstanceID</relatedStateVariable>"
        + "        </argument>" + "        <argument>"
        ...
        + "          <relatedStateVariable>GreenVideoBlackLevel</relatedStateVariable>"
        + "        </argument>" + "      </argumentList>" + "    </action>"
        + "    <action><Optional/>" + "    <name>GetBlueVideoBlackLevel</name>"
        + "      <argumentList>" + "        <argument>"
        + "          <name>InstanceID</name>" + "          <direction>in</direction>"
        + "          <relatedStateVariable>A_ARG_TYPE_InstanceID</relatedStateVariable>"
        + "        </argument>" + "        <argument>"
        ...
        + "        </argument>" + "      </argumentList>" + "    </action>"
        + "    <action><Optional/>" + "    <name>SetBlueVideoBlackLevel</name>"
        + "      <argumentList>" + "        <argument>"
        + "          <name>InstanceID</name>" + "          <direction>in</direction>"
        + "          <relatedStateVariable>A_ARG_TYPE_InstanceID</relatedStateVariable>"
        + "        </argument>" + "        <argument>"
        ...
        + "  <relatedStateVariable>BlueVideoBlackLevel</relatedStateVariable>"
        + "        </argument>" + "      </argumentList>" + "    </action>"
        + "    <action><Optional/>" + "    <name>GetColorTemperature </name>"
        + "      <argumentList>" + "        <argument>"
        + "          <name>InstanceID</name>" + "          <direction>in</direction>"
        + "          <relatedStateVariable>A_ARG_TYPE_InstanceID</relatedStateVariable>"
        + "        </argument>" + "        <argument>"
        ...
        + "        </argument>" + "      </argumentList>" + "    </action>"
        + "    <action><Optional/>" + "    <name>SetColorTemperature</name>"
        + "      <argumentList>" + "        <argument>"
        + "          <name>InstanceID</name>" + "          <direction>in</direction>"
        + "          <relatedStateVariable>A_ARG_TYPE_InstanceID</relatedStateVariable>"
        + "        </argument>" + "        <argument>"
        ...
        + "          <relatedStateVariable>ColorTemperature</relatedStateVariable>"
        + "        </argument>" + "      </argumentList>" + "    </action>"
        + "    <action><Optional/>" + "    <name>GetHorizontalKeystone</name>"
        + "      <argumentList>" + "        <argument>"
        + "          <name>InstanceID</name>" + "          <direction>in</direction>"
        + "          <relatedStateVariable>A_ARG_TYPE_InstanceID</relatedStateVariable>"
        + "        </argument>" + "        <argument>"
        ...
        + "        </argument>" + "      </argumentList>" + "    </action>"
        + "    <action><Optional/>" + "    <name>SetHorizontalKeystone</name>"
        + "      <argumentList>" + "        <argument>"
        + "          <name>InstanceID</name>" + "          <direction>in</direction>"
        + "          <relatedStateVariable>A_ARG_TYPE_InstanceID</relatedStateVariable>"
        + "        </argument>" + "        <argument>"
        ...
        + "          <relatedStateVariable>HorizontalKeystone</relatedStateVariable>"
        + "        </argument>" + "      </argumentList>" + "    </action>"
        + "    <action><Optional/>" + "    <name>GetVerticalKeystone</name>"
        + "      <argumentList>" + "        <argument>"
        + "          <name>InstanceID</name>" + "          <direction>in</direction>"
        + "          <relatedStateVariable>A_ARG_TYPE_InstanceID</relatedStateVariable>"
        + "        </argument>" + "        <argument>"
        ...
        + "        </argument>" + "      </argumentList>" + "    </action>"
        + "    <action><Optional/>" + "    <name>SetVerticalKeystone</name>"
        + "      <argumentList>" + "        <argument>"
        + "          <name>InstanceID</name>" + "          <direction>in</direction>"
        + "          <relatedStateVariable>A_ARG_TYPE_InstanceID</relatedStateVariable>"
        + "        </argument>" + "        <argument>"
        ...
        + "          <relatedStateVariable>VerticalKeystone</relatedStateVariable>"
        + "        </argument>" + "      </argumentList>" + "    </action>"
        + "    <action><Optional/>" + "    <name>GetMute</name>" + "      <argumentList>"
        + "        <argument>" + "          <name>InstanceID</name>"
        + "          <direction>in</direction>"
        + "          <relatedStateVariable>A_ARG_TYPE_InstanceID</relatedStateVariable>"
        + "        </argument>" + "        <argument>" + "          <name>Channel</name>"
        + "          <direction>in</direction>"
        ...
        + "        </argument>" + "      </argumentList>" + "    </action>"
        + "    <action><Optional/>" + "    <name>SetMute</name>" + "      <argumentList>"
        + "        <argument>" + "          <name>InstanceID</name>"
        + "          <direction>in</direction>"
        + "          <relatedStateVariable>A_ARG_TYPE_InstanceID</relatedStateVariable>"
        + "        </argument>" + "        <argument>" + "          <name>Channel</name>"
        ...
        + "          <relatedStateVariable>Mute</relatedStateVariable>"
        + "        </argument>" + "      </argumentList>" + "    </action>"
        + "    <action><Optional/>" + "    <name>GetVolume</name>"
        + "      <argumentList>" + "        <argument>"
        + "          <name>InstanceID</name>" + "          <direction>in</direction>"
        + "          <relatedStateVariable>A_ARG_TYPE_InstanceID</relatedStateVariable>"
        + "        </argument>" + "        <argument>" + "          <name>Channel</name>"
        ...
        + "        </argument>" + "      </argumentList>" + "    </action>"
        + "    <action><Optional/>" + "    <name>SetVolume</name>"
        + "      <argumentList>" + "        <argument>"
        + "          <name>InstanceID</name>" + "          <direction>in</direction>"
        + "          <relatedStateVariable>A_ARG_TYPE_InstanceID</relatedStateVariable>"
        + "        </argument>" + "        <argument>" + "          <name>Channel</name>"
        ...
        + "          <relatedStateVariable>Volume</relatedStateVariable>"
        + "        </argument>" + "      </argumentList>" + "    </action>"
        + "    <action><Optional/>" + "    <name>GetVolumeDB</name>"
        + "      <argumentList>" + "        <argument>"
        + "          <name>InstanceID</name>" + "          <direction>in</direction>"
        + "          <relatedStateVariable>A_ARG_TYPE_InstanceID</relatedStateVariable>"
        + "        </argument>" + "        <argument>" + "          <name>Channel</name>"
        ...
        + "        </argument>" + "      </argumentList>" + "    </action>"
        + "    <action><Optional/>" + "    <name>SetVolumeDB</name>"
        + "      <argumentList>" + "        <argument>"
        + "          <name>InstanceID</name>" + "          <direction>in</direction>"
        + "          <relatedStateVariable>A_ARG_TYPE_InstanceID</relatedStateVariable>"
        + "        </argument>" + "        <argument>" + "          <name>Channel</name>"
        ...
        + "          <relatedStateVariable>VolumeDB</relatedStateVariable>"
        + "        </argument>" + "      </argumentList>" + "    </action>"
        + "    <action><Optional/>" + "    <name>GetVolumeDBRange</name>"
        + "      <argumentList>" + "        <argument>"
        + "          <name>InstanceID</name>" + "          <direction>in</direction>"
        + "          <relatedStateVariable>A_ARG_TYPE_InstanceID</relatedStateVariable>"
        + "        </argument>" + "        <argument>" + "          <name>Channel</name>"
        ...
        + "          <relatedStateVariable>VolumeDB</relatedStateVariable>"
        + "        </argument>" + "      </argumentList>" + "    </action>"
        + "    <action><Optional/>" + "    <name>GetLoudness</name>"
        + "      <argumentList>" + "        <argument>"
        + "          <name>InstanceID</name>" + "          <direction>in</direction>"
        + "          <relatedStateVariable>A_ARG_TYPE_InstanceID</relatedStateVariable>"
        + "        </argument>" + "        <argument>" + "          <name>Channel</name>"
        ...
        + "        </argument>" + "      </argumentList>" + "    </action>"
        + "    <action><Optional/>" + "    <name>SetLoudness</name>"
        + "      <argumentList>" + "        <argument>"
        + "          <name>InstanceID</name>" + "          <direction>in</direction>"
        + "          <relatedStateVariable>A_ARG_TYPE_InstanceID</relatedStateVariable>"
        + "        </argument>" + "        <argument>" + "          <name>Channel</name>"
