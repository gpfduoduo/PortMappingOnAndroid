...
public class MediaRenderer extends Device
{
    ...
    public MediaRenderer()
    {
        ...
        try
        {
            initialize(DESCRIPTION, RenderingControl.SCPD, ConnectionManager.SCPD,
                AVTransport.SCPD);
        }
    ...
    public MediaRenderer(String description, String renderCtrlSCPD, String conMgrSCPD,
            String avTransSCPD) throws InvalidDescriptionException
    {
        super();
        initialize(description, renderCtrlSCPD, conMgrSCPD, avTransSCPD);
    }

    private void initialize(String description, String renderCtrlSCPD, String conMgrSCPD,
            String avTransSCPD) throws InvalidDescriptionException
    {
    ...
    public void httpRequestReceived(HTTPRequest httpReq)
    {
         ...
         * getContentDirectory().contentExportRequestRecieved(httpReq); return;
         * }
         */
