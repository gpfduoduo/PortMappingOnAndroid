 ...
 * Revision:
 *
 * 10/30/03 - first revision. 10/26/04 - Brent Hills <bhills@openshores.com> -
 * Changed DIDLLiteNode is a subclass of Node instead of ContentNode because the
 * node has the parentID attributes.
 *
 ******************************************************************/
