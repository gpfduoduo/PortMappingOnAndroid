...
public abstract class Header
{
    ...
    public final static byte[] getID(InputStream inputStream, int headerOffset,
            int headerSize)
    {
    ...
    public final static String getIDString(InputStream inputStream, int headerOffset,
            int headerSize)
    {
