 ...
 * Revision;
 *
 * 12/17/02 - first revision. 02/13/04 - Ralf G. R. Bergs <Ralf@Ber.gs>, Inma
 * Marin Lopez <inma@dif.um.es>. - Added XML header, <?xml version="1.0"?> to
 * setContent(). 05/11/04 - Changed the XML header to <?xml version="1.0"
 * encoding="utf-8"?> in setContent().
 *
 ******************************************************************/
